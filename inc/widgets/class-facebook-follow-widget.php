...
if ( class_exists( '\FM_Widget' ) ) {
	...
	class Facebook_Follow_Widget extends \FM_Widget {
		...
		public function widget( $args, $instance ) {
			...
			printf(
				'<div id="%s" class="terminal-follow terminal-facebook terminal-facebook-sidebar terminal-sidebar-body-font"><div class="terminal-custom-sidebar-interior"><a href="%s" target="_blank">%s %s</a></div></div>',
