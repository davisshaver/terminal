	...
	<div class="post-row">
		...
		<div class="more">
			...
			<div class="more-comments">
				<a href="<?php the_permalink(); ?>#comments">💬</a> <span class="fb_comment_count share-number" data-post-url="<?php the_permalink(); ?>">0</span>
			</div>
			<div class="more-text">
				<a href="<?php the_permalink(); ?>"><strong>Read Post</strong></a>
			</div>
		</div>
	</div>
</div>
